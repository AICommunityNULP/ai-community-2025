...
const Program = () => {
    ...
    const scheduleItems = [
        ...
        { start: "15:20", end: "16:00", title: "Спікер 3: Бойчук Андрій", desc: "AI як інструмент покращення процесу вивчення та впровадження військового досвіду" },
        { start: "16:00", end: "16:05", title: "Перерва", desc: null },
        { start: "16:05", end: "16:30", title: "Аукціон для 25 бригади", desc: null },
