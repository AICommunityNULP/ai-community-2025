...
const Program = () => {
    ...
    const scheduleItems = [
        ...
        { start: "12:00", end: "12:40", title: "Спікер 2: Засоба Євгеній", desc: "Поєднання академічного ML з реальними проблемами робототехніки"},
        ...
        { start: "15:45", end: "16:25", title: "Аукціон для 3 та 25 та 93 бригад", desc: null },
