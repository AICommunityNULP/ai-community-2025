...
const Program = () => {
    ...
    const scheduleItems = [
        ...
        { start: "11:15", end: "11:55", title: "Спікер 1: Богдан Діденко", desc: "Поточний стан справ у галузі українських LLM" },
        { start: "11:55", end: "12:00", title: "Перерва", desc: null },
        { start: "12:00", end: "12:40", title: "Спікер 2: Засоба Євгеній", desc: "Bridge academic ML with real-world robotics pain"},
            ...
            customContent: (
                <>
                    <h4><span>Панельна дискусія 1: Як ваш АІ-проєкт оцінюють інвестори</span> <br />
                        ...
                        Учасники: Горовий Євген, Панів Юрій (Lapa)
                    </h4>
                    <br />
                    <h4><span>Панельна дискусія 2: Технічна тема (AI-Engineering Panel)</span> <br />
                        Модератор: Яцишин Володимир <br />
                        Учасники: Засоба Євгеній, Шамуратов Олексій, Красній Данило (IT-Jim)
                    </h4>
                </>
            )
        },
        ...
        { start: "15:10", end: "15:40", title: "Спікер 3: Бойчук Андрій", desc: "AI як інструмент покращення процесу вивчення та впровадження військового досвіду" },
        { start: "15:40", end: "15:45", title: "Перерва", desc: null },
        { start: "15:45", end: "16:25", title: "Аукціон для 3 та 25 бригади", desc: null },
        ...
        { start: "17:00", end: "17:05", title: "Завершення / Подяка", desc: "Мельникова Наталія" },
    ];
