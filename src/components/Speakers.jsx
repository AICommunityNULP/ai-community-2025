...
//{ name: "Анастасія Фролова", title: "Панель 3: Етичні та соціальні аспекти", type: "panel", imgId: 10 },
        ...
        { name: "Al Community 2025 благодійний аукціон", title: "Кожен лот - це не просто річ, а можливість зробити реальний внесок у підтримку Збройних сил України та допомогти тим, хто щодня виборює наше майбутнє.\n\n" +
